...
| 2026-09-19 | Launch form: cloth type + condition (+ random) and shirts-in-a-row mix (`same` / `random` / `list`). Catalogue on `GET /capabilities`; `LineDriver` rebuilds `SimSession` when the SKU changes. | dashboard + bridge |
