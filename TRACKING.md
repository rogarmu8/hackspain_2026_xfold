...
| 2026-09-19 | **Infeed orient** before the press. Default (`good`) is square; **skewed** is a random heading. A turner squares the shirt collar-downstream, then the linear belt takes it. Phase `ORIENT` sits between LOAD and TO_PRESS. | press track |
| | | |
